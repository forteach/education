...
public class CourseChapterController {
    ...
    public WebResult getCourseChapterById(@Valid @NotEmpty(message = "科目ID不为空") @ApiParam(value = "根据资源ID 查询对应上层科目信息", name = "chapterId", required = true) @RequestBody String chapterId){
