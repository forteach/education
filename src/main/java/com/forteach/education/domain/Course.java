...
public class Course extends Entitys implements Serializable {
    ...
    @NotNull(message = "授课类型不为空") //TODO -->
    @Range(min = 1, max = 3, message = "授课类型不正确")
    @ApiModelProperty(value = "授课类型", name = "teachingType", dataType = "int", notes = "1、录播课程 2、直播课程 3、线下课堂", example = "1、录播课程 2、直播课程 3、线下课堂", required = true)
